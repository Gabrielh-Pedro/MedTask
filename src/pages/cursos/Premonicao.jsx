  ...
  return (
    <>
      <HomeContainer>
        <LeftCont1>
          <h1>
            A revisão certa<span className="gradient-text"> na hora certa!</span>
          </h1>
          <h2>
            O Premonições MedTask é um curso de reta final, desenvolvido para revisar os tópicos mais cobrados e mais prováveis na prova.
          </h2>
          <button className="superButton">QUERO DESCOBRIR MAIS!</button>
        </LeftCont1>
        <RightCont1>
          <ImageStyled src="revisao.png" alt="Marcus" />
        </RightCont1>
      </HomeContainer>
      ...
      <Container name="next-section">
        <h1>
          ...
          <h2>
          Com um método dinâmico e objetivo, você revisa o essencial sem desperdício de tempo.            </h2>
        </h1>
        <CardsContainer>
          <Card
            style={{
          ...
          >
            ...
            <CardTitle>Curso intensivo de 5 dias.</CardTitle>
          </Card>
          <Card
            style={{
              backgroundPosition: isHovered ? `${bgPosition.x}% ${bgPosition.y}%` : "center",
          ...
          >
            ...
            <CardTitle>Cada dia foca em uma grande área.</CardTitle>
          </Card>
          <Card
            style={{
              backgroundPosition: isHovered ? `${bgPosition.x}% ${bgPosition.y}%` : "center",
          ...
          >
            ...
            <CardTitle>Aulas de 3 a 4 horas, abordando os temas mais prevalentes.</CardTitle>
          </Card>
          <button className="superButton">QUERO CONHECER O PREMONIÇÕES!</button>
        </CardsContainer>
      </Container>

      <Container2>
        <h1>
          O que você encontra no <span className="gradient-textCut"> Premonições MedTask?</span>
        </h1>
        <CardsContainer>
          <Card2
            style={{
          ...
          >
            ...
            <CardTitle>Direcionamento com base nas provas recentes.</CardTitle>
          </Card2>
          <Card2
            style={{
              backgroundPosition: isHovered ? `${bgPosition.x}% ${bgPosition.y}%` : "center",
