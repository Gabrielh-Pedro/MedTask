...
import Valuetion3 from "./Valuetion3";
import Valuetion4 from "./Valuetion4";
  ...
  return (
    <>
      <HomeContainer>
        <LeftCont1>
          <h1>
            Ferramentas inteligentes para <span className="gradient-text"> potencializar seus estudos!</span>
          </h1>
          <h2>
          Além dos cursos completos, a MedTask oferece recursos exclusivos para aprimorar sua preparação e garantir retenção de longo prazo.
          </h2>
          <button className="superButton">QUERO DESCOBRIR MAIS!</button>
        </LeftCont1>
        <RightCont1>
          <ImageStyled src="extras.png" alt="Marcus" />
        </RightCont1>
      </HomeContainer>
      ...
      <Container name="next-section">
        <h1>
          ...
          <h2>
          Ferramentas únicas para otimizar todo seu caminho até o triunfo.         </h2>
        </h1>
        <CardsContainer>
          <Card
            style={{
          ...
          >
            ...
            <CardTitle>Banco de questões comentadas e atualizadas</CardTitle>
          </Card>
          <Card
            style={{
              backgroundPosition: isHovered ? `${bgPosition.x}% ${bgPosition.y}%` : "center",
          ...
          >
            ...
            <CardTitle>Flashcards inteligentes para revisão otimizada.</CardTitle>
          </Card>
          <Card
            style={{
              backgroundPosition: isHovered ? `${bgPosition.x}% ${bgPosition.y}%` : "center",
          ...
          >
            ...
            <CardTitle>Simulados adaptativos para reforçar pontos fracos.</CardTitle>
          </Card>
          <button className="superButton">QUERO CONHECER O MAIS!</button>
        </CardsContainer>
      </Container>

      <Container2>
        <h1>
          O que você encontra nos <span className="gradient-textCut"> Recursos Extras MedTask?</span>
        </h1>
        <CardsContainer>
          <Card2
            style={{
          ...
          >
            ...
            <CardTitle>Questões comentadas para aprofundamento.</CardTitle>
          </Card2>
          <Card2
            style={{
              backgroundPosition: isHovered ? `${bgPosition.x}% ${bgPosition.y}%` : "center",
          ...
          >
            ...
            <CardTitle>Revisão objetiva para maior retenção.</CardTitle>
          </Card2>
          <Card2
            style={{
              backgroundPosition: isHovered ? `${bgPosition.x}% ${bgPosition.y}%` : "center",
          ...
          >
            ...
            <CardTitle>Simulados e exercícios práticos.</CardTitle>
          </Card2>
          <Card2
            style={{
              backgroundPosition: isHovered ? `${bgPosition.x}% ${bgPosition.y}%` : "center",
          ...
          >
            ...
            <CardTitle>Conteúdo direto e sem enrolação.</CardTitle>
          </Card2>
